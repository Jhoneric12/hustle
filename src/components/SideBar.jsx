    ...
    <>
        <div className={isOpen ? 'hidden' : 'p-4 w-full'}>
            <div className='flex gap-4 items-center'>
                <svg onClick={handleOpen} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className='w-4 h-4 md:w-5 md:h-5'>
